...
namespace OpenAPI.WorldGenerator.Generators.Decorators
{
    public abstract class ChunkDecorator
    {
        ...
        public abstract void Decorate(int chunkX, int chunkZ, int[] blocks, int[] metadata, Biome biome, float[] thresholdMap, int x, int y, int z, bool surface, bool isBelowMaxHeight);
